...
?>
	    ...
	    <br>
	    <label for="cantidad">Que tan grande es la cantidad de euros que quieres cambiar?:</label>
	    <input type="text" name="number" value="<?php echo $cantidad ?>"><br>
...
echo "Tiene un cambio respecto al euro de: ".$cantidad*$mi_cambio[$moneda]."<br>";
}
?>
        <hr>
    </body>
