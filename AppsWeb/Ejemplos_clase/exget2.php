    ...
    ?>
	    ...
	    <label for="cars">Choose a car:</label>
            <select id="cars" name="cars">
                ...
                <option default selected value="audi">Audi</option>
            </select>
            <br>
            ...
            <input checked type="checkbox" id="vehicle1" name="vehicle1" value="Bici">
            ...
            <input type="submit" id="oo" value="Saludar">
		<script>
			//yago
			function edad(){
			var ed = document.getElementByID("edat";
			edd = ed.value;
			if(edd<18){alert("error"){
